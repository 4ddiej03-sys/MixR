...
export default function LandingPage({ onGetStarted }) {
  ...
  return (
    <div style={{ background: "#080808", color: "#f0ebe3", minHeight: "100vh", fontFamily: "'Georgia', serif", overflowX: "hidden" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-fixed {
          ...
          border-bottom: 1px solid rgba(37,99,235,0.15); transition: border-color 0.3s;
        }
        .nav-scrolled { border-bottom-color: rgba(37,99,235,0.4); }
        .cta-btn {
        ...
        .cta-btn-outline { background: transparent; border: 1px solid rgba(37,99,235,0.5); color: #2563eb; }
        .cta-btn-outline:hover { background: rgba(37,99,235,0.1); border-color: #2563eb; }
        .feature-card {
        ...
        .feature-card:hover { border-color: rgba(37,99,235,0.3); background: rgba(37,99,235,0.04); transform: translateY(-2px); }
        .badge-pill {
          display: inline-block; border: 1px solid rgba(37,99,235,0.4); color: #2563eb;
        ...
        .step-num {
          ...
          color: rgba(37,99,235,0.15); line-height: 1; position: absolute; top: -10px; left: 0;
        }
        ...
        .countdown-box {
          display: inline-flex; background: rgba(37,99,235,0.08);
          border: 1px solid rgba(37,99,235,0.3); padding: 16px 24px;
      ...
      {/* How it works */}
      <section style={{ padding: "80px 24px", background: "rgba(37,99,235,0.04)", borderTop: "1px solid rgba(37,99,235,0.1)", borderBottom: "1px solid rgba(37,99,235,0.1)", position: "relative", zIndex: 1 }}>
      ...
      <section style={{ padding: "80px 24px", maxWidth: 800, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ border: "1px solid rgba(37,99,235,0.3)", padding: "48px", background: "rgba(37,99,235,0.04)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {["🇯🇵 Japanese", "🇵🇭 Filipino", "🇳🇿 Māori", "🇲🇾 Malaysian", "🇲🇽 Mexican", "🇨🇺 Cuban", "🇧🇷 Brazilian", "🇰🇷 Korean"].map((t, i) => (
              <span key={i} className="body-font" style={{ fontSize: 13, color: "#2563eb", border: "1px solid rgba(37,99,235,0.3)", padding: "6px 14px" }}>{t}</span>
            ))}
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
          ...
          <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "rgba(240,235,227,0.06)", marginBottom: 32 }}>
            {[
              ...
              <div key={i} style={{ padding: 24, background: p.highlight ? "rgba(37,99,235,0.08)" : "#080808", border: p.highlight ? "1px solid rgba(37,99,235,0.3)" : "none", textAlign: "left", position: "relative" }}>
